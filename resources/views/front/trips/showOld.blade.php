                                ...
                                <div class="itinerary-row">
                                    ...
                                    <div class="itinerary-text">
                                        <div class="collapse-toggle">
                                            <button data-bs-target="#day{{ $itinerary->id }}" aria-expanded="false" aria-controls="day{{ $itinerary->id }}">
                                        ...
                                        <div id="day{{ $itinerary->id }}" class="collapse day-details">
                ...
                <div id="inclusions" class="tour-details-section">
                    <div class="bg-white p-3">
                        ...
                        <div class="complimentary p-2">
                            <h3>Complimentary</h3>
                            <ul class="trip-includes" style="padding: 0px;">
            ...
            <aside class="py-4">
                ...
                <div class="experts-card">
                    ...
                    <div class="experts-phone flex mb-1"><a href="#" class="flex aic"><svg class="icon-md mr-1">
                            ...
                            +977 -9849683653</a></div>
                    <div class="experts-phone flex mb-3"><a href="mailto:" class="flex aic"><svg class="icon-md mr-1">
                                <use xlink:href="{{ asset('assets/front/img/sprite.svg#mail') }}" /></svg> info@hikerhimalaya.com</a></div>
