            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    ...
                    <div class="kt-form__actions mt-3">
                        <a href="{{ route('admin.videos.index') }}" class="btn btn-sm btn-secondary">Cancel</a>
                ...
                <!--begin::Form-->
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            <label>Link</label>
                            <input type="url" name="link" class="form-control" placeholder="">
                        </div>
                        {{-- <div class="form-group">
                            <label>Title</label>
...
$(function() {
    ...
    function handleVideoAddForm(form) {
      var form = $(form);
      ...
      $.ajax({
          ...
          success: function(res) {
              if (res.status === 1) {
                  location.href = '{{ route("admin.videos.index") }}';
              }
          }
      });
    }
