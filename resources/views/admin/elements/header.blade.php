    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ config('app.name') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <div class="kt-notification">
                    ...
                    <div class="kt-notification__custom kt-space-between">
                        <!-- <a href="{{ route('auth.logout') }}" class="btn btn-label btn-label-brand btn-sm btn-bold pull-right">Logout</a> -->
                        <a href="{{ route('auth.logout') }}" style="width: 100%;" class="btn btn-clean btn-sm btn-bold pull-right">Logout</a>
