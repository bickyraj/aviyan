            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{ route('admin.galleries.add') }}" class="btn btn-sm btn-brand btn-icon-sm">
...
@endsection
@push('scripts')
<script src="./assets/js/data-gallery-list.js" data-id="gallery-list-script" data-url="{{ url('/') }}" type="text/javascript"></script>
