            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    ...
                    <div class="kt-form__actions mt-3">
                        <a href="{{ route('admin.galleries.index') }}" class="btn btn-sm btn-secondary">Cancel</a>
...
$(function() {
    ...
    function handleGalleryAddForm(form) {
      var form = $(form);
      ...
      $.ajax({
          ...
          success: function(res) {
              if (res.status === 1) {
                  location.href = '{{ route('admin.galleries.index') }}';
              }
          }
      });
    }
