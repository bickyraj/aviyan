    ...
    <div class="row">
        <div class="col">
            ...
            <div class="kt-portlet">
                <form class="kt-form" id="add-form-news" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="{{ route('admin.news.index') }}" class="btn btn-sm btn-secondary">Cancel</a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-lg-7">
                                <div class="mb-3">
                                    <img id="cropper-image" class="crop-img-div" src="{{ $event->image_url }}">
                                </div>
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $event->name }}" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Title" required>
                        </div>
                        <div class="form-group">
                            <label>Date</label>
                            <input name="event_date" readonly value="{{ $event->event_date }}" class="form-control datepicker" data-date-format="yyyy-mm-dd" aria-describedby="" placeholder="">
                        </div>
                        <div class="form-group">
...
$(function() {
  ...
  function initSummerNote() {
    ...
    let code = `{!! $event->description !!}`;
    $('#summernote-description').summernote("code", code);
    // $('#summernote-description').summernote();

  }
  $("#add-form-news").validate({
