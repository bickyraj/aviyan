                                ...
                                <div class="cf nestable-lists">
                                    <div class="dd" id="nestable">
                                        <ol class="dd-list">
                                            ...
                                            @endif
                                            @if($teams)
                                              <li class="dd-item" data-type="main" data-name="teams" data-id="4">
                                                  <div class="dd-handle">Teams</div>
                                                  <ol class="dd-list">
                                                  @foreach($teams as $team)
                                                    <li class="dd-item" data-type="team" data-name="<?= $team->name; ?>" data-id="<?= $team->id; ?>">
