            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{ route('admin.teams.add') }}" class="btn btn-sm btn-brand btn-icon-sm">
...
@endsection
@push('scripts')
<script src="./assets/js/data-team-list.js" data-id="team-list-script" data-url="{{ url('/') }}" type="text/javascript"></script>
@endpush
